...
.. code-block:: batch
 ...
 PowerShell -Command "& {$client = new-object System.Net.WebClient; $client.DownloadFile('https://github.com/lordmikefin/LMAutoSetBotWin/releases/download/v0.0.3/LMAutoSetBotWin.zip','.\LMAutoSetBotWin.zip')}"
